...
const SocialLinks = ({ links }: SocialLinkProps) => {
  return (
    <>
      {links.discord !== 'N/A' ? (
        <Link href={links.discord} target="_blank" rel="noopener noreferrer">
          <Tooltip title="Discord">
            <IconButton
              size="small"
              sx={{ margin: '0 4px 0 4px', width: 42, height: 42, color: '#b6995b'}}
            >
              <svg
        ...
        <Link href={links.instagram} target="_blank" rel="noopener noreferrer">
          <Tooltip title="Instagram">
            <IconButton
              size="small"
              color="primary"
              sx={{ margin: '0 4px 0 4px', width: 42, height: 42 }}
            >
              <svg
                className="member-social-media-icon"
                role="img"
      ...
      {links.reddit !== 'N/A' ? (
        <Link href={links.reddit} target="_blank" rel="noopener noreferrer">

...
const SocialLinks = ({ login, links }: SocialLinkProps) => {
  return (
    <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Link
          ...
          onClick={() => {
            ReactGA.event({
              ...
              action:
                login !== null
                  ? `Clicked Discord link for ${login}`
                  : links.discord,
            })
          }}
        >
        ...
        <Link
          ...
          onClick={() => {
            ReactGA.event({
              ...
              action:
                login !== null
                  ? `Clicked Instagram link for ${login}`
                  : links.instagram,
            })
          }}
        >
        ...
        <Link
          ...
          onClick={() => {
            ReactGA.event({
              ...
              action:
                login !== null
                  ? `Clicked Twitter link for ${login}`
                  : links.twitter,
            })
          }}
        >
        ...
        <Link
          ...
          onClick={() => {
            ReactGA.event({
              ...
              action:
                login !== null
                  ? `Clicked YouTube link for ${login}`
                  : links.youtube,
            })
          }}
        >
      ...
      {links.vrchat_legends !== 'N/A' ? (
        <Link
          href={links.vrchat_legends}
          target="_blank"
          rel="noopener noreferrer"
          onClick={() => {
            ReactGA.event({
              ...
              action:
                login !== null
                  ? `Clicked VRC Legends link for ${login}`
                  : links.vrchat_legends,
            })
          }}
        >
          <Tooltip title="VRChat Legends">
            <IconButton
              size="small"
              color="info"
